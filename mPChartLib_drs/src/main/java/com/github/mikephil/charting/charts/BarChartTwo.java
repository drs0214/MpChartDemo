 ...
 */
public class BarChartTwo extends BarChart {
	...
	public BarChartTwo(Context context) {
		super(context);
	}

	public BarChartTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public BarChartTwo(Context context, AttributeSet attrs, int defStyle) {
