...
public class CombinedData extends BarLineScatterCandleData<BarLineScatterCandleDataSet<?>> {
  ...
  /*  public CombinedData(ArrayList<String> xVals, ArrayList<CombinedData> dataSets) {
        super(xVals, dataSets);
    }

    public CombinedData(String[] xVals, ArrayList<CombinedData> dataSets) {
        super(xVals, dataSets);
    }

    public CombinedData(ArrayList<String> xVals, CombinedData dataSet) {
        super(xVals, toArrayList(dataSet));
    }

    public CombinedData(String[] xVals, CombinedData dataSet) {
        super(xVals, toArrayList(dataSet));
    }
*/
